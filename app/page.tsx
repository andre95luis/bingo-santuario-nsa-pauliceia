...
// Paleta sofisticada — sem cores primárias de brinquedo
    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "#ffffff", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          {/* Logo acima da bola — sem sombra, transparência natural do PNG */}
          <Image
            src="/logo.png"
              ...
              {lastBall ? (
                <>
                  ...
                  <span style={{
                    ...
                    fontWeight: 900, letterSpacing: "5px", lineHeight: 1,
                  }}>
                    {lastLetter}
                  </span>
                  <span style={{
          ...
          {recentBalls.length > 0 && (
            <div style={{ width: "100%", flexShrink: 0 }}>
              <div style={{ fontSize: "7px", color: G.mid, letterSpacing: "3px", textAlign: "center", marginBottom: "7px", fontWeight: 700 }}>
                ÚLTIMAS BOLAS
              </div>
          ...
          {allDone && (
            <div style={{
              ...
              <div style={{ fontSize: "16px", fontWeight: 900, color: NAVY, letterSpacing: "2px" }}>
                JOGO COMPLETO!
              </div>
            </div>
          )}
          ...
          {!confirmReset ? (
            <button
              ...
              style={{
                padding: "12px 24px", background: "transparent", width: "100%",
        ...
        <div style={{
          ...
          {/* Células — 5 colunas × 15 linhas = 75 números */}
          <div style={{
            display: "grid",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "clamp(13px, 2.1vw, 25px)",
                      fontWeight: 900,
                      cursor: "pointer",
                      boxShadow: isLast
      ...
      <footer style={{
        ...
        {/* Ticker rolando — grande o suficiente para projetor */}
